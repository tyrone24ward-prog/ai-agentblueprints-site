...
export const metadata: Metadata = {
  title: "Terms of Service | AgentBlueprints",
  description: "Read the AgentBlueprints Terms of Service.",
};
...
We are Tyrone Ward, doing business as AgentBlueprints ("Company," "we," "us," "our"), a company registered in California, United States at 1798 Technology Dr Ste 178, San Jose, CA 95110.

We operate the website http://www.ai-agentblueprints.io (the "Site"), as well as any other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").

We provide information about other sites.

You can contact us by email at tyrone24ward@gmail.com, or by mail to 1798 Technology Dr Ste 178, San Jose, CA 95110, United States.

These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you"), and Tyrone Ward, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.
...
11. PRIVACY POLICY
We care about data privacy and security. Please review our Privacy Policy: http://www.AI-agentblueprints.io/privacy. By using the Services, you agree to be bound by our Privacy Policy, which is incorporated into these Legal Terms. Please be advised the Services are hosted in the United States. If you access the Services from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in the United States, then through your continued use of the Services, you are transferring your data to the United States, and you expressly consent to have your data transferred to and processed in the United States.
...
AgentBlueprints
1798 Technology Dr Ste 178
San Jose, CA 95110
United States
tyrone24ward@gmail.com
  ...
  return (
    <main className="min-h-screen bg-[#050b16] text-white">
      <section className="mx-auto max-w-5xl px-6 py-12">
        <h1 className="text-3xl font-semibold text-[#4FE3FF]">Terms of Service</h1>
        <p className="mt-2 text-sm text-blue-100/80">Last updated February 20, 2026</p>
        <article className="mt-8 rounded-2xl border border-blue-400/20 bg-white/5 p-6">
          <pre className="whitespace-pre-wrap text-sm leading-7 text-blue-50">{termsText}</pre>
        </article>
      </section>
    </main>
  );
